...
class PickerAdapter(
    ...
    private val useDetailView: Boolean
        ...
        return when (viewType) {
            TYPE_CAMERA -> {
                ...
                ViewHolderImage(
                    ...
                    if (useDetailView) {
                        imgSeeDetail.visibility = View.INVISIBLE
                    } else {
                        imgSeeDetail.visibility = View.VISIBLE
                    }

                    imgSeeDetail.setOnClickListener {
                        onPickerActionListener.onClickSeeDetail(adapterPosition)
                    }
    ...
    class ViewHolderImage(
        ...
        val imgSeeDetail: ImageView = itemView.findViewById(R.id.btn_see_detail)
