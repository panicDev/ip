...
import com.paniclabs.imagepicker.datasource.CameraDataSourceImpl
import com.paniclabs.imagepicker.datasource.ImageDataSourceImpl
import com.paniclabs.imagepicker.datasource.ImagePickerDataSourceImpl
import com.paniclabs.imagepicker.datasource.PickerIntentDataSourceImpl
import com.paniclabs.imagepicker.permission.PermissionCheck
import com.paniclabs.imagepicker.ui.detail.ui.DetailImageActivity.Companion.getDetailImageActivity
import com.paniclabs.imagepicker.ui.picker.listener.OnPickerActionListener
import com.paniclabs.imagepicker.ui.picker.model.PickerListItem
import com.paniclabs.imagepicker.ui.picker.model.PickerRepositoryImpl
import com.paniclabs.imagepicker.ui.picker.model.PickerViewData
import com.paniclabs.imagepicker.util.MainUiHandler
import com.paniclabs.imagepicker.util.SingleMediaScanner
...
class PickerActivity : BaseActivity(),
    ...
    private val pickerPresenter: PickerContract.Presenter by lazy {
        PickerPresenter(
            this, PickerRepositoryImpl(
                ...
                ImagePickerDataSourceImpl(IPConfig),
        ...
        when (requestCode) {
            TAKE_A_PICTURE_REQUEST_CODE -> {
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    if (pickerPresenter.isUseOnlyCamera()) {
    ...
    override fun showImageList(
        ...
        setImageList(imageList, adapter, hasCameraInPickerPage, useDetailView)
    }
    ...
    override fun onClickSeeDetail(position: Int) {
        pickerPresenter.onClickSeeDetail(position)
    }
    ...
    override fun finishActivityWithResult(selectedImages: List<Uri>) {
        val i = Intent()
        setResult(Activity.RESULT_OK, i)
        i.putParcelableArrayListExtra(ImagePicker.INTENT_PATH, ArrayList(selectedImages))
        finish()
    }
    ...
    private fun setImageList(
        ...
        if (adapter == null) {
            adapter = PickerAdapter(imageAdapter, this, hasCameraInPickerPage, useDetailView)
