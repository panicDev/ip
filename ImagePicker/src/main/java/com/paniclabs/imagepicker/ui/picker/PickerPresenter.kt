...
import com.paniclabs.imagepicker.ui.picker.model.PickerRepository
import com.paniclabs.imagepicker.util.UiHandler
import com.paniclabs.imagepicker.util.future.CallableFutureTask
import com.paniclabs.imagepicker.util.future.FutureCallback
...
class PickerPresenter internal constructor(
    ...
    override fun successTakePicture(addedImagePath: Uri) {
        ...
        if (pickerRepository.isUseOnlyCamera()) {
            pickerRepository.selectImage(addedImagePath)
    ...
    override fun isUseOnlyCamera(): Boolean = pickerRepository.isUseOnlyCamera()
        ...
        imageUriList.map {
            ...
            uiHandler.run {
                pickerView.showImageList(
                    ...
                    pickerRepository.useDetailView()
                )
                setToolbarTitle()
            }
        }
